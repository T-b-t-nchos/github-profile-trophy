export const COLORS: { [name: string]: Theme } = {
  ...
  GhDark: {
    ...
    SECRET_RANK_3: "#c273ff",
    SECRET_RANK_TEXT: "#bd93f9",
    NEXT_RANK_BAR: "#16a34a",
    S_RANK_BASE: "#b870ff",
    S_RANK_SHADOW: "#b870ff",
    S_RANK_TEXT: "#b870ff",
    A_RANK_BASE: "#db9d00",
    A_RANK_SHADOW: "#db9d00",
    A_RANK_TEXT: "#db9d00",
    B_RANK_BASE: "#3094ff",
    B_RANK_SHADOW: "#3094ff",
    B_RANK_TEXT: "#3094ff",
    DEFAULT_RANK_BASE: "#e4ebe6",
    DEFAULT_RANK_SHADOW: "#e4ebe6",
    DEFAULT_RANK_TEXT: "#e4ebe6",
  },
  GhLight: {
    BACKGROUND: "#f6f8fa",
    TITLE: "#16a34a",
    ...
    B_RANK_SHADOW: "#3094ff",
    B_RANK_TEXT: "#3094ff",
    DEFAULT_RANK_BASE: "#232925",
    DEFAULT_RANK_SHADOW: "#232925",
    DEFAULT_RANK_TEXT: "#232925",
  },
};
